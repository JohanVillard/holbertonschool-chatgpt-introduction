...
def factorial(n):
    ...
    Function Description: this function calculates the factorial of a non-negative integer n using recursion.
    ...
    Parameters n: a non-negative integer whose factorial is to be computed.
        Must be an integer greater than or equal to 0.

    Returns: the factorial of the input integer n. If n is 0, returns 1.
    """
